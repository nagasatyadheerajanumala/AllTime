        ...
        NavigationView {
            ScrollView {
                VStack(spacing: 30) {
                    ...
                    // Loading Indicators
                    if googleAuthManager.isAuthenticating || microsoftAuthManager.isAuthenticating || oauthManager.isAuthenticating {
                        VStack(spacing: 12) {
                            ProgressView()
                                .progressViewStyle(CircularProgressViewStyle(tint: .blue))
                                .scaleEffect(1.2)
                            Text(googleAuthManager.isAuthenticating ? "Opening Google OAuth..." : 
